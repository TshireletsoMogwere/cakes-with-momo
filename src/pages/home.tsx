          ...
          <div className="flex-1 relative">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-500">
              <img
                ...
                alt="A person joyfully enjoying a chocolate cupcake, showcasing the delightful experience of our baked goods"
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
          <span className="text-white font-semibold px-4 py-2 bg-red-400 rounded-full transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
            Explore Collection
          </span>
        </div>
      </div>
      ...
      <div className="p-6">
        <h3 className="text-xl font-bold text-teal-600 mb-2 group-hover:text-teal-700 transition-colors">
          {collection.title}
        </h3>
      </div>
    </Link>
